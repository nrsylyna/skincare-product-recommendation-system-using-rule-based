    ...
    <body>
        <?php
            ...
            if(isset($_POST["login"])) {
                ...
                $query1 = "SELECT * FROM users WHERE users_email = '$userEmail' AND users_password = '$userPassword'";
                $result1 = mysqli_query($conn, $query1) or die (mysqli_error($conn));

                $query2 = "SELECT * FROM admin WHERE admin_email = '$userEmail' AND admin_password = '$userPassword'";
        ...
        <div class="loginbox">
            ...
            <form method="post">
                ...
                <a href="password.php"><p style="text-align:center">Forgot Password?</p></a>
                <a href="register.php"><p style="text-align:center">Create Account</p></a><br>
            </form>
        </div>
